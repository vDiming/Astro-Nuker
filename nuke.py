...
░██▄▄▄▄██   ▒   ██▒░ ▓██▓ ░ ▒██▀▀█▄  ▒██   ██░
 ...
 ▒▒   ▓▒█░▒ ▒▓▒ ▒ ░  ▒ ░░   ░ ▒▓ ░▒▓░░ ▒░▒░▒░ 
  ...
  ░   ▒   ░  ░  ░    ░        ░░   ░ ░ ░ ░ ▒  
      ░  ░      ░              ░         ░ ░  
Made by Cread | Visit .gg/zGXmKsYGzt for more tools.
 """)
...
async def on_ready():
    ...
    title(f"[Astro | .gg/zGXmKsYGzt] Waiting for {PREFIX}n in guild..")
    print(f"""\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n{blue}
 ▄▄▄        ██████ ▄▄▄█████▓ ██▀███   ▒█████  
▒████▄    ▒██    ▒ ▓  ██▒ ▓▒▓██ ▒ ██▒▒██▒  ██▒
▒██  ▀█▄  ░ ▓██▄   ▒ ▓██░ ▒░▓██ ░▄█ ▒▒██░  ██▒
...
{gray}[{blue}{PREFIX}p{gray}]{white} Toggle Pinging""")
    while True:
        if guild != "":
            ...
            bans_before = 0
            while True:
                title(f"[Astro | .gg/zGXmKsYGzt] Nuking {guild.name} // Pinging: {pinging} - Pings/s: {pings - pings_before} // Banning: {banning} - Bans/s: {bans - bans_before}")
                pings_before = pings
                bans_before = bans
